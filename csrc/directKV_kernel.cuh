...
enum class DirectKVBarrier : uint32_t { OSmemReady = 0, MergeStatsReady = 1, QRotReady = 2 };
                ...
                for (int m_block = 0; m_block < m_end; ++m_block) {
                    ...
                    if (params.rope_mode == 1 && params.q_pos_start >= 0) {
                        ...
                        cutlass::arch::NamedBarrier::sync(
                            ...
                            static_cast<uint32_t>(DirectKVBarrier::QRotReady));
                    }
                    ...
                    cutlass::arch::NamedBarrier::sync(
                        static_cast<uint32_t>(kNThreadsMMA),
                        static_cast<uint32_t>(DirectKVBarrier::OSmemReady));
                    ...
                    // Row index uses NH_q (total Q-heads) and q_head (this g's Q-head).
                    {
                        ...
                        cutlass::arch::NamedBarrier::sync(
                            static_cast<uint32_t>(kNThreadsMMA),
                            static_cast<uint32_t>(DirectKVBarrier::MergeStatsReady));
                    }
                }   // end m_block loop
